...
INSERT INTO "public"."column" VALUES (1, 'Chan Sze Yu', 'https://mypic-1305118058.cos.ap-hongkong.myqcloud.com/img/Snipaste_2022-11-17_17-13-59.png', 'Secure Sockets Layer(SSL) is a protocol for transmitting private documents via the Internet.', '2020-02-29 12:47:10.905023+08', '2013-03-27 17:58:16.905023+08', 4);
...
SELECT setval('"public"."post_comment_id_seq"', 23, true);
...
-- ----------------------------
-- Foreign Keys structure for table column
-- ----------------------------
ALTER TABLE "public"."column" ADD CONSTRAINT "column_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."sys_user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- ----------------------------
ALTER TABLE "public"."user_column_follow" ADD CONSTRAINT "fk_user_column_column_1" FOREIGN KEY ("column_id") REFERENCES "public"."column" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
